...
button_0 = Button(calculator_screen,text="0",command=lambda: numbers_command(0))
...
button_1 = Button(calculator_screen,text="1",command=lambda: numbers_command(1))
button_1.place(x=0,y=300,height=buttons_height,width=buttons_width)
button_2 = Button(calculator_screen,text="2",command=lambda: numbers_command(2))
button_2.place(x=70,y=300,height=buttons_height,width=buttons_width)
button_3 = Button(calculator_screen,text="3",command=lambda: numbers_command(3))
...
button_4 = Button(calculator_screen,text="4",command=lambda: numbers_command(4))
button_4.place(x=0,y=250,height=buttons_height,width=buttons_width)
button_5 = Button(calculator_screen,text="5",command=lambda: numbers_command(5))
button_5.place(x=70,y=250,height=buttons_height,width=buttons_width)
button_6 = Button(calculator_screen,text="6",command=lambda: numbers_command(6))
...
button_7 = Button(calculator_screen,text="7",command=lambda: numbers_command(7))
button_7.place(x=0,y=200,height=buttons_height,width=buttons_width)
button_8 = Button(calculator_screen,text="8",command=lambda: numbers_command(8))
button_8.place(x=70,y=200,height=buttons_height,width=buttons_width)
button_9 = Button(calculator_screen,text="9",command=lambda: numbers_command(9))
